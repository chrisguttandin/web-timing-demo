...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('@angular/core'), require('babel-runtime/helpers/createClass'), require('babel-runtime/helpers/classCallCheck'), require('babel-runtime/helpers/possibleConstructorReturn'), require('babel-runtime/helpers/inherits'), require('tslib'), require('rxjs/operators'), require('rxjs-broker')) :
    typeof define === 'function' && define.amd ? define(['exports', 'rxjs', '@angular/core', 'babel-runtime/helpers/createClass', 'babel-runtime/helpers/classCallCheck', 'babel-runtime/helpers/possibleConstructorReturn', 'babel-runtime/helpers/inherits', 'tslib', 'rxjs/operators', 'rxjs-broker'], factory) :
    (factory((global.rxjsConnector = {}),global.rxjs,global.core,global._createClass,global._classCallCheck,global._possibleConstructorReturn,global._inherits,global.tslib_1,global.operators,global.rxjsBroker));
}(this, (function (exports,rxjs,core,_createClass,_classCallCheck,_possibleConstructorReturn,_inherits,tslib_1,operators,rxjsBroker) { 'use strict';
    ...
    var awaitDataChannel = function awaitDataChannel(iceServers, webSocketSubject) {
        return new rxjs.Observable(function (observer) {
            ...
            var candidateChannelSubscription = candidateChannel.subscribe(function (_ref) {
                ...
                .addIceCandidate(new RTCIceCandidate(candidate)).catch(function () {
            ...
            var descriptionChannelSubscription = descriptionChannel.subscribe(function (_ref2) {
                ...
                peerConnection
                // @todo Remove casting again when possible.
                .setRemoteDescription(new RTCSessionDescription(description)).catch(function () {
    ...
    var DATA_CHANNEL_ACCEPTING_OBSERVABLE_FACTORY_PROVIDER = {
        deps: [iceServers],
        provide: DataChannelAcceptingObservableFactory
    };
    ...
    var DATA_CHANNEL_REQUESTING_OBSERVABLE_FACTORY_PROVIDER = {
        deps: [iceServers],
        provide: DataChannelRequestingObservableFactory
    };
    ...
    var DataChannelsAcceptingObservable = function (_Observable) {
        ...
        function DataChannelsAcceptingObservable(_ref) {
            ...
            return _possibleConstructorReturn(this, (DataChannelsAcceptingObservable.__proto__ || Object.getPrototypeOf(DataChannelsAcceptingObservable)).call(this, function (observer) {
                return webSocketSubject.mask({ type: 'request' }).pipe(operators.mergeMap(function (_ref2) {
    ...
    var DATA_CHANNELS_ACCEEPTING_OBSERVABLE_FACTORY_PROVIDER = {
        deps: [DataChannelAcceptingObservableFactory],
        provide: DataChannelsAcceptingObservableFactory
    };

    var injector = core.Injector.create({
        providers: [DATA_CHANNEL_ACCEPTING_OBSERVABLE_FACTORY_PROVIDER, DATA_CHANNEL_REQUESTING_OBSERVABLE_FACTORY_PROVIDER, DATA_CHANNELS_ACCEEPTING_OBSERVABLE_FACTORY_PROVIDER, ICE_SERVERS_PROVIDER]
    });
